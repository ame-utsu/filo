...
module Color =
  ...
  module BasicColor =
    ...
    module Foreground =
      ...
      let brightRed = baseToAnsi (int BaseColor.Red) Foreground true
      let brightGreen = baseToAnsi (int BaseColor.Green) Foreground true
      let brightYellow = baseToAnsi (int BaseColor.Yellow) Foreground true
      let brightBlue = baseToAnsi (int BaseColor.Blue) Foreground true
      let brightMagenta = baseToAnsi (int BaseColor.Magenta) Foreground true
      let brightCyan = baseToAnsi (int BaseColor.Cyan) Foreground true
      let brightWhite = baseToAnsi (int BaseColor.White) Foreground true
    ...
    module Background =
      ...
      let brightRed = baseToAnsi (int BaseColor.Red) Background true
      let brightGreen = baseToAnsi (int BaseColor.Green) Background true
      let brightYellow = baseToAnsi (int BaseColor.Yellow) Background true
      let brightBlue = baseToAnsi (int BaseColor.Blue) Background true
      let brightMagenta = baseToAnsi (int BaseColor.Magenta) Background true
      let brightCyan = baseToAnsi (int BaseColor.Cyan) Background true
      let brightWhite = baseToAnsi (int BaseColor.White) Background true
